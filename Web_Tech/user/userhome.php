...
$currentUser = $_SESSION['email'];
    ...
    $sql = "SELECT * FROM doctor  WHERE doctorID = '$doctor'";
    


    $sql = "INSERT INTO appointment (p_email,d_id, appDate, appTime, appSymptoms, appComments) VALUES ('$currentUser','$doctor', '$date', '$time', '$symptoms', '$comment')";
                            ...
                            <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                ...
                                <?php
                                        ...
                                        <select class="form-select" aria-label="Default select example" name="doctor">
                                            ...
                                            ?>
                                             <option value="<?= $row['doctorID'];?>"><?= $row['d_FullName'];?></option>
                                                <?php
                                            }
                                            }
