...
if(isset($_POST['appointsub'])) {
    ...
    $sql = "UPDATE appointment SET requestID =  '$id', appDate = '$date', appTime = '$time', appSymptoms = '$symptoms', appComments = '$comment' WHERE requestID = '$id'";
                        ...
                        <div class="col">
                            <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                ...
                                <select class="form-select" aria-label="Default select example" name="doctor" id="doctor">
                                    ...
                                    ?>
                                    <option value="<?= $row['d_FullName']?>"><?= $row['d_FullName'];?></option>
                                    <?php
                                    }
                                    }
