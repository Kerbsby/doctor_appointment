                            ...
                            <div class="col-md-3 col-sm-3">
                                ...
                                <div class="user-wrapper">
                                    <div class="description">
                                        <h4><?php echo $row['d_FullName'] ?></h4>
                                        <h5> <strong> Doctor </strong></h5>

                                        <hr />
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#doctorprofile"><a class="glyphicon glyphicon-edit" style="text-decoration: none;" href="/Web_Tech/doctor/doctorprofile.php?update=<?php echo $row['doctorID']; ?>" title="Edit">Update Profile</a></button>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post" >
                        <table class="table table-user-information">
                            ...
                            <tr>
                                <td>Phone number</td>
                                <td><input type="text" name="dNumber" value="" id="number" class="form-control input-lg" placeholder="Your Phone Number"  required/></td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td><input type="email" name="dEmail" value="" id="email" class="form-control input-lg " placeholder="Your Email"  required/></td>
                            </tr>
                            <tr>
                                <td>Address</td>
                                <td><input type="text" name="dAddress" value="" id="address" class="form-control input-lg" placeholder="Address" required /></td>
                            </tr>
                            <tr>
                                <td>Specialize in</td>
                                <td><textarea class="form-control" name="comments" id="comments" placeholder="Field" rows="3"></textarea></td>
                            </tr>
                            <tr>
                                <td>DOB</td>
                                <td>
