                    ...
                    <table class="table bg-white rounded shadow-sm  table-hover">
                        ...
                        <tr class="text-center">
                            ...
                            <td>
                                ...
                                <button type="button" name="update" id="act_button" class="btn btn-warning btn-xs update" data-bs-toggle="modal" data-bs-target="#myUpdate"><a class="glyphicon glyphicon-edit" style="text-decoration: none;" href="?update=<?php echo $row['requestID']; ?>" title="Edit">Edit</a></button>
