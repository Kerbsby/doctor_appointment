        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <p class="text-white">Please login to make an appointment</p>
                </div>
            </div>
        </div>
    </div>
...
<footer>
    ...
    <div class="footer_bottom">
        <div class="container">
            ...
            <p class="pull-right small"><a href="/Web_Tech/admin/adminlogin.php" style="color: white; text-decoration: none;">admin</a></p>
        </div>
    </div>
