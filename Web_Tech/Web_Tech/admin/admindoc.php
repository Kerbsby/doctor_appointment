...
if(isset($_GET['delete'])){
    ...
    header('Location: /Web_Tech/admin/admindoc.php');
};
?>
...
if(isset($_POST['appointsub'])){
    ...
    $sql = "UPDATE doctor SET doctorID = '$id', d_FullName = '$fullname',d_DOB = '$DOB',d_gender = '$gender', d_address = '$address', d_number = '$number', d_email = '$email', d_specialize = '$comment'  WHERE doctorID = '$id'";
    $result = mysqli_query($conn, $sql);
    if ($result) {
        header('Location: /Web_Tech/admin/admindoc.php');
    }
                ...
                <div class="row my-5">
                    ...
                    <div class="col-12 col-md-5">
                        <div class="form-group mb-0">
                            <button type="submit" class="btn medilife-btn" id="medilife" data-bs-toggle="modal" data-bs-target="#adddoc">Doctor <span>+</span></button>
                        </div>
                    </div>
                    <div class="row my-4">
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_array($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" id="act_button" class="btn btn-warning btn-xs update" data-bs-toggle="modal" data-bs-target="#updatedoc"><a class="glyphicon glyphicon-edit" style="text-decoration: none;" href="?update=<?php echo $row['doctorID']; ?>" title="Edit">Edit</a></button>
                                                    <button type="button" name="delete" id="act_button" class="btn btn-warning btn-xs update"><a class="glyphicon glyphicon-edit" style="text-decoration: none;" href="/Web_Tech/admin/admindoc.php?delete=<?php echo $row['doctorID']; ?>" title="Edit">Delete</a></button>
                        ...
                        <div class="col">
                            <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                <table class="table table-user-information">
                                    ...
                                    <input type="text" name="dFullName" value="" id="fullname" class="form-control input-lg" placeholder="Full Name" required />
                                    <label>Number</label>
                                    <input type="text" name="dNumber" value="" id="number" class="form-control input-lg" placeholder="Your Phone Number"  required/>
                                    <label>Email</label>
                                    <input type="email" name="dEmail" value="" id="email" class="form-control input-lg " placeholder="Your Email"  required/>
                                    <label>Address</label>
...
<div class="modal fade" id="adddoc" tabindex="-1" role="dialog" aria-labelledby="myModal">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <!-- modal content -->
            <div class="modal-header">
                            ...
                            <form class="form" role="form" method="POST" accept-charset="UTF-8">
                                <div class="row">
                                    <div class="col-sm-6 col-sm-6">
                                        <label>FullName</label><input type="text" name="dFullName" value="" id="dfullname" class="form-control input-lg" placeholder="Full Name" required />
                                    </div>
                                    <div class="col-sm-6 col-sm-6">
                                ...
                                <div class="d-md-flex justify-content-md-end">
                                    <button class="btn me-md-2 signup-btn" type="submit" name="adddoc" id="adddoc">Create my account</button>
                                </div>
